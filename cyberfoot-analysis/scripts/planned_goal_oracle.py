"""0061c6f4 with original scorer; event recording/presentation captured as adapters."""
...
for i in range(1000):
 ...
 out=run(0x61c6f4,[0,tick,1],seed)
...
p=R.parent/'cyberfoot-web/native-port/tests/planned-goal-vectors.json';p.write_text(json.dumps(cases,separators=(',',':')));print('Original scheduled goal delivery:1000 cases')
