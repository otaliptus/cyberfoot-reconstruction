...
void FUN_0053dc9c(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  *in_FS_OFFSET = uVar2;
  FUN_004048f8(&local_28,4,iVar3,&LAB_0053ddcd);
  return;
}
