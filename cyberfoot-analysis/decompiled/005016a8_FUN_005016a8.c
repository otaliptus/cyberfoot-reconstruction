...
void FUN_005016a8(int param_1,undefined4 param_2,undefined4 *param_3)

{
  ...
  local_38 = param_3[2];
  local_34 = param_3[3];
  uVar3 = FUN_004e4c08(0xb,CONCAT31((int3)((uint)PTR_DAT_0066aeb0 >> 8),*PTR_DAT_0066aeb0));
  cVar2 = FUN_0050a2ac(param_2);
  if (cVar2 == '\0') {
    FUN_004e697c(*(undefined4 *)(param_1 + 8),&local_40,0xffffff,uVar3);
  }
  else {
    FUN_004e697c(*(undefined4 *)(param_1 + 8),&local_40,uVar3,0xffffff);
  }
  iVar1 = *(int *)(param_1 + 8);
