...

{
  ...
  *in_FS_OFFSET = &uStack_20;
  ...
  if ((*(char *)(in_stack_00000004 + -0x29) == '\0') ||
     ((*(char *)(in_stack_00000004 + -0x21) != '\0' &&
      (*(char *)(*(int *)(in_stack_00000004 + -0x38) + 0x38) == '\0')))) {
  ...
  *(int *)(in_stack_00000004 + -0xc) = iVar6;
  FUN_00404cf0(*(undefined4 *)(*(int *)(in_stack_00000004 + -0x38) + 0x30),&DAT_004785e8);
  if (bVar17) {
    FUN_0042af8c(*(undefined4 *)(in_stack_00000004 + -0x28),in_stack_00000004 + -0x20);
...
LAB_00477e5e:
    ...
    if (iVar6 < 0) {
LAB_00477e37:
      if (*(char *)(*(int *)(in_stack_00000004 + -0x38) + 0x38) == '\0') goto LAB_00477e5e;
      piVar2 = *(int **)(*(int *)(in_stack_00000004 + -0x38) + 0x4c);
      if (piVar2 != (int *)0x0) {
        cVar4 = (**(code **)(*piVar2 + 0x1c))();
        if (cVar4 == '\0') goto LAB_00477e5e;
      }
    }
    else {
      iVar7 = FUN_00473f5c(*(undefined4 *)(in_stack_00000004 + -0x40));
      if (iVar7 <= iVar6) goto LAB_00477e37;
    }
    uVar5 = 1;
  }
  ...
  if (*(char *)(in_stack_00000004 + -0x41) == '\0') {
    ...
    if ((*(int *)(in_stack_00000004 + -0x40) == 0) || (*(char *)(in_stack_00000004 + 8) != '\0')) {
      ...
      *(int *)(in_stack_00000004 + -0x10) =
           *(int *)(in_stack_00000004 + -8) - *(int *)(*(int *)(in_stack_00000004 + -0x40) + 0x34);
    ...
    if (*(char *)(in_stack_00000004 + -0x41) == '\0') {
      ...
      *puVar15 = *puVar13;
      ...
      if (iVar6 < *(int *)(in_stack_00000004 + -8) - *(int *)(in_stack_00000004 + -0x10)) {
        ...
        *(int *)(in_stack_00000004 + -8) = (*(int *)(in_stack_00000004 + -8) - iVar6) + 1;
        iVar6 = (**(code **)(**(int **)(*(int *)(in_stack_00000004 + -0x38) + 0x4c) + 0x2c))();
        *(int *)(in_stack_00000004 + -0x10) = *(int *)(in_stack_00000004 + -8) - iVar6;
      }
...
LAB_00478017:
      ...
      iVar7 = FUN_00473f5c(*(undefined4 *)(in_stack_00000004 + -0x40));
      if (iVar7 <= iVar6) goto LAB_00478017;
...
LAB_0047829f:
  ...
  *puVar15 = *puVar13;
  ...
  if ((*(byte *)(in_stack_00000004 + 0xc) & 0x20) != 0) {
    FUN_0042a66c(*(undefined4 *)(*(int *)(in_stack_00000004 + -0x28) + 0xc),DAT_004785ec);
  }
  ...
  *(undefined4 *)(in_stack_00000004 + -0x20) = *(undefined4 *)(in_stack_00000004 + -0x5c);
  *(undefined4 *)(in_stack_00000004 + -0x18) = *(undefined4 *)(in_stack_00000004 + -0x54);
  ...
  if ((sVar1 != 0) && (*(char *)(in_stack_00000004 + 8) == '\0')) {
    ...
    *(undefined4 *)(in_stack_00000004 + -0x20) = 10;
    iVar6 = FUN_0042b3e4(*(undefined4 *)(in_stack_00000004 + -0x28),local_8);
    *(int *)(in_stack_00000004 + -0x18) = iVar6 + *(int *)(in_stack_00000004 + -0x20);
    iVar6 = in_stack_00000004 + -0x20;
    in_stack_ffffffbc = 2;
    FUN_00477170(*(undefined4 *)(in_stack_00000004 + -0x38),
                 *(undefined4 *)(in_stack_00000004 + -0x28),local_8,2,
                 *(undefined1 *)(in_stack_00000004 + -0x29));
  }
  *in_FS_OFFSET = in_stack_ffffffbc;
  FUN_004048d4(&local_8,in_stack_ffffffbc,iVar6,&LAB_004785d7);
  return;
}
