...
void FUN_00553264(undefined4 param_1,int param_2,int param_3,undefined4 param_4,undefined4 param_5,
...

{
  ...
  puStack_19c = (undefined1 *)0x553284;
  local_10 = param_3;
  local_c = param_2;
  local_8 = param_1;
  FUN_00404d94(param_10);
  puStack_1a0 = &LAB_00553451;
  ...
  *in_FS_OFFSET = &uStack_1a4;
  ...
  if ((param_10 != 0) && (local_14 != 0)) {
    ...
    if ((cVar2 == '\0') && (cVar2 = FUN_0055323c(param_10), cVar2 == '\0')) {
      UVar11 = 0x4010;
      UVar9 = 0x160;
      pSVar7 = &local_17c;
      DVar6 = 0;
  ...
  if ((param_7 & param_8) != 0) {
    ...
    FUN_00553160(local_8,&local_18c,piVar5);
    FUN_00403a84(piVar5);
  }
  puVar1 = puStack_19c;
  *in_FS_OFFSET = uStack_1a4;
  puStack_19c = &LAB_00553458;
  puStack_1a0 = (undefined1 *)0x553450;
