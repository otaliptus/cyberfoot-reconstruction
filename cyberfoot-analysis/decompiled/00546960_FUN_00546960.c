...
void FUN_00546960(undefined4 param_1,int param_2,int param_3,undefined4 param_4,undefined4 param_5,
...

{
  ...
  puStack_1a0 = (undefined1 *)0x546980;
  local_10 = param_3;
  local_c = param_2;
  local_8 = param_1;
  FUN_00404d94(param_10);
  puStack_1a4 = &LAB_00546b64;
  ...
  *in_FS_OFFSET = &uStack_1a8;
  ...
  if ((param_10 != 0) && (local_14 != 0)) {
    ...
    if ((cVar2 == '\0') && (cVar2 = FUN_0054693c(param_10), cVar2 == '\0')) {
      UVar11 = 0x4010;
      UVar10 = 0x160;
      pSVar8 = &local_180;
      DVar7 = 0;
  ...
  FUN_0041c968(local_18,local_1c,param_4);
  ...
  if ((param_7 & param_8) == 0) {
    *in_FS_OFFSET = uStack_1a8;
    puStack_1a0 = &LAB_00546b6b;
    puStack_1a4 = (undefined1 *)0x546b63;
  ...
  *in_FS_OFFSET = &stack0xfffffe4c;
  ...
  FUN_00546860(local_8,&local_190,local_20);
  *in_FS_OFFSET = uVar9;
