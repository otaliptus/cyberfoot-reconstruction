...
void FUN_0054a8f0(int param_1,undefined4 param_2,int *param_3)

{
  ...
  puStack_164 = (undefined1 *)0x54a941;
  local_cc[0] = param_2;
  FUN_00405608(local_cc);
  puStack_168 = &LAB_0054b060;
  ...
  *in_stack_00000010 = 0xffffffff;
  ...
  iVar16 = FUN_00405574(&DAT_0054b07c,local_cc[0]);
  if (0 < iVar16) {
    do {
      cVar2 = FUN_00547814(L"&amp;",&DAT_0054b084,local_cc);
      cVar3 = FUN_00547814(L"&quot;",&DAT_0054b0a0,local_cc);
      cVar4 = FUN_00547814(L"&sect;",&DAT_0054b0bc,local_cc);
      cVar5 = FUN_00547814(L"&permil;",&DAT_0054b0d8,local_cc);
      cVar6 = FUN_00547814(L"&reg;",&DAT_0054b0fc,local_cc);
      cVar7 = FUN_00547814(L"&copy;",&DAT_0054b114,local_cc);
      cVar8 = FUN_00547814(L"&para;",&DAT_0054b130,local_cc);
      cVar9 = FUN_00547814(L"&trade;",&DAT_0054b14c,local_cc);
      cVar10 = FUN_00547814(L"&euro;",&DAT_0054b168,local_cc);
    } while (cVar10 != '\0' ||
             (cVar9 != '\0' ||
             (cVar8 != '\0' ||
             (cVar7 != '\0' ||
  ...
  FUN_00547618(local_cc[0],&local_148);
  thunk_FUN_0040502c(local_cc,local_148);
  FUN_005476d8(local_cc[0],1,&local_14c);
  ...
  while (iVar16 = FUN_00405260(local_cc[0]), 0 < iVar16) {
    ...
    local_52 = 0;
    local_51 = 0;
    iVar16 = FUN_0054796c(param_1,local_cc[0]);
    local_118 = local_bc;
    puVar15 = &local_150;
    local_dc = iVar16;
    FUN_00547a4c(param_1,local_cc,local_140 + 3,puVar15,local_140 + 7,local_80,&local_f2,&local_f1,
    ...
    if (in_stack_00000058 == '\0') {
      ...
      *in_stack_00000014 = local_10c;
      ...
      local_bc = local_118;
      puVar15 = &local_154;
      FUN_00547a4c(param_1,local_d8 + 1,&local_144,puVar15,local_140 + 7,local_80,&local_f2,
      ...
      local_110 = local_ac;
      if ((((local_f1 != '\0') &&
           (iVar13 = FUN_0054796c(param_1,&DAT_0054b184,puVar15),
  ...
  if (*in_stack_00000018 == 0) {
    iVar16 = FUN_0054796c(param_1,&DAT_0054b184);
  ...
  *in_FS_OFFSET = uStack_16c;
  puStack_164 = &LAB_0054b067;
  puStack_168 = (undefined1 *)0x54b036;
  FUN_00405008(&local_154,4,puVar1);
  puStack_168 = (undefined1 *)0x54b041;
  FUN_004048d4(&local_f8);
  puStack_168 = (undefined1 *)0x54b04c;
  FUN_00404ff0(local_d8 + 1);
  puStack_168 = (undefined1 *)0x54b057;
  FUN_00404ff0(local_cc);
  puStack_168 = (undefined1 *)0x54b05f;
