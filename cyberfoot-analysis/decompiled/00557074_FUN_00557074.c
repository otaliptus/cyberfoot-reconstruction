...
void FUN_00557074(undefined4 param_1,undefined4 param_2,undefined4 param_3,int param_4)

{
  ...
  puStack_198 = (undefined1 *)0x5570e0;
  local_b4[0] = param_3;
  FUN_00404d94(param_3);
  puStack_19c = &LAB_00557851;
  ...
  *in_stack_00000014 = 0xffffffff;
  ...
  local_94 = 0xffffffff;
  local_2c = 0x268;
  iVar11 = FUN_00404ee8(&DAT_00557870,local_b4[0]);
  if (0 < iVar11) {
  ...
  iVar11 = FUN_00404ee8(&DAT_0055787c,local_b4[0]);
  if (0 < iVar11) {
    do {
      cVar2 = FUN_00553fc8("&amp;",&DAT_00557888,local_b4);
      cVar3 = FUN_00553fc8("&quot;",&DAT_005578a4,local_b4);
      cVar4 = FUN_00553fc8("&sect;",&DAT_005578c0,local_b4);
      cVar5 = FUN_00553fc8("&permil;",&DAT_005578dc,local_b4);
      cVar6 = FUN_00553fc8("&reg;",&DAT_005578fc,local_b4);
      cVar7 = FUN_00553fc8("&copy;",&DAT_00557918,local_b4);
      cVar8 = FUN_00553fc8("&para;",&DAT_00557934,local_b4);
      cVar9 = FUN_00553fc8("&trade;",&DAT_00557950,local_b4);
      cVar10 = FUN_00553fc8("&euro;",&DAT_0055796c,local_b4);
    } while (cVar10 != '\0' ||
             (cVar9 != '\0' ||
             (cVar8 != '\0' ||
             (cVar7 != '\0' ||
  ...
  FUN_00553dd0(local_b4[0],local_17c);
  FUN_0040496c(local_b4,local_17c[0]);
  FUN_00553e94(local_b4[0],1,&local_180);
  ...
  while (iVar11 = FUN_00404ba4(local_b4[0]), 0 < iVar11) {
    ...
    local_1e = 0;
    local_1d = 0;
    iVar11 = FUN_004af3c4(param_1,&DAT_00557988,local_1c);
    local_120 = local_90;
    puVar15 = &local_184;
    local_c4 = iVar11;
    FUN_00554084(param_1,local_b4,local_150 + 3,puVar15,local_12c,local_44,&local_de,&local_dd,
    ...
    if (in_stack_0000005c == '\0') {
      ...
      *in_stack_00000018 = local_fc;
      local_74 = local_100;
      local_90 = local_120;
      FUN_00554084(param_1,local_c0 + 1,&local_154,&local_188,local_12c,local_44,&local_de,&local_dd
                   ,in_stack_00000070,in_stack_00000074,&local_cc,&local_c5,&local_f4,&local_f0,
                   &local_ec,&local_c4,local_c0,in_stack_00000060,&stack0xfffffffc);
      local_fc = *in_stack_00000018;
      local_100 = local_74;
      if ((((local_dd != '\0') &&
           (iVar12 = FUN_004af3c4(param_1,&DAT_00557988,local_1c),
  ...
  *in_FS_OFFSET = uStack_1a0;
  puStack_198 = &LAB_00557858;
  puStack_19c = (undefined1 *)0x55780f;
  FUN_004048f8(&local_188,4,puVar1);
  puStack_19c = (undefined1 *)0x55781a;
  FUN_004048d4(local_e8);
  puStack_19c = (undefined1 *)0x557825;
  FUN_004048d4(local_c0 + 1);
  puStack_19c = (undefined1 *)0x557830;
  FUN_004048d4(local_b4);
  puStack_19c = (undefined1 *)0x557840;
  FUN_004048f8(&local_a8,2);
  puStack_19c = (undefined1 *)0x557848;
  FUN_004048d4(&local_34);
  puStack_19c = (undefined1 *)0x557850;
