...
void FUN_00573b98(undefined4 param_1,int param_2,undefined4 param_3)

{
  ...
  *in_FS_OFFSET = &uStack_38;
  ...
  FUN_0040502c(param_3,local_14[3]);
  *in_FS_OFFSET = uVar2;
  FUN_004048f8(&local_24,4,uVar5,&LAB_00573ca4);
  FUN_00404ff0(local_14 + 3);
  return;
}
