...
void TForm63_Image5Click(int param_1)

{
  ...
  *in_FS_OFFSET = &uStack_2c;
  ...
  if (*(int *)(PTR_DAT_0066ac78 + 0x19c) == 1) {
    FUN_0054c10c(*(undefined4 *)(param_1 + 0x37c),*(int *)(PTR_DAT_0066ac78 + 0x1a0) + -1);
  }
  else {
    FUN_0054c10c(*(undefined4 *)(param_1 + 0x37c),*(int *)(PTR_DAT_0066ac78 + 0x1a0) + 2);
  }
  if (*(int *)(PTR_DAT_0066ac78 + 0x1a0) < 4) {
    uStack_30 = *(undefined4 *)(PTR_DAT_0066ac78 + 0x19c);
    FUN_005c5d38(param_1,6,*(int *)(PTR_DAT_0066ac78 + 0x1a0));
  }
  else {
    uStack_30 = 2;
    FUN_005c5d38(param_1,6,3);
    FUN_0054c10c(*(undefined4 *)(param_1 + 0x37c),5);
  }
  FUN_00465978(*(undefined4 *)(param_1 + 0x360),*(undefined4 *)(*(int *)(param_1 + 0x35c) + 0x40));
  puVar1 = puStack_28;
  *in_FS_OFFSET = uStack_30;
  puStack_28 = &LAB_005c7ee4;
  uStack_2c = 0x5c7ecf;
