...
void FUN_0052d1d0(undefined4 param_1,int *param_2,undefined4 param_3,undefined4 param_4,
  ...
  do {
    ...
    if (((iVar8 < 1) || (bVar1)) || (uStack_28._3_1_ != '\0')) {
      *param_17 = *param_17 - iVar18;
      ...
      puVar3 = local_20;
      *in_FS_OFFSET = (uint)uStack_28;
      local_20 = &LAB_0052fef7;
      local_24 = (undefined1 *)0x52fea1;
      FUN_004048f8(auStackY_1870 + 0x5d8,8,puVar3);
      local_24 = (undefined1 *)0x52feac;
      FUN_004048d4(&local_e0);
      local_24 = (undefined1 *)0x52febc;
      FUN_004048f8(&local_d4,8);
      local_24 = (undefined1 *)0x52fec7;
      FUN_004048d4(&local_b4);
      local_24 = (undefined1 *)0x52fed2;
      FUN_004048d4(&local_b0);
      local_24 = (undefined1 *)0x52fee2;
      FUN_004048f8(&local_a0,3);
      local_24 = (undefined1 *)0x52feef;
      FUN_004048f8(&local_24,7);
      return;
    }
    local_44 = FUN_00404ee8(&DAT_0052ff08,*param_2);
    if ((char)param_19[0x13] == '\0') {
      iVar8 = 0;
    }
    else {
      iVar8 = FUN_00404ee8(&DAT_0052ff14,*param_2);
    }
    ...
    while (iVar18 = FUN_00404ee8("&nbsp;",local_c), 0 < iVar18) {
      FUN_0052d114("&nbsp;",&DAT_0052ff14,&local_c);
    }
    while (iVar18 = FUN_00404ee8(&DAT_0052ff30,local_c), 0 < iVar18) {
      FUN_0052d114(&DAT_0052ff30,&DAT_0052ff08,&local_c);
    }
    while (iVar18 = FUN_00404ee8(&DAT_0052ff4c,local_c), 0 < iVar18) {
      FUN_0052d114(&DAT_0052ff4c,&DAT_0052ff40,&local_c);
    }
      ...
      if (*(char *)((int)param_19 + -0x1b) == '\0') {
        ...
        if (bVar14) {
          ...
          if (!(bool)uVar15) {
            ...
            puStackY_3c = (uint *)0x52d4fe;
            FUN_004af154(local_8,local_c,local_68);
            uVar15 = -param_19[0x1a] == 0;
            puStackY_3c = (uint *)0x52d519;
            FUN_0040715c(&local_94,-param_19[0x1a],-param_19[0x1a]);
            puStackY_3c = (uint *)0x52d527;
            FUN_0042a3a0(param_19[-6],local_58);
          }
          FUN_00404cf0(local_c,&DAT_0052ff14);
          if ((bool)uVar15) {
            uStack_28 = (uint *)0x1fffffff;
            puStackY_3c = (uint *)0x52d563;
            FUN_004af154(local_8,local_c,local_68);
          }
          else {
            ...
            *(undefined1 *)((int)param_19 + -0x29) = 0;
            ...
            if ((uVar6 & 4) != 0) {
              ...
              iVar18 = FUN_00404ee8(&DAT_0052ff14,param_19[-1]);
              if (0 < iVar18) {
                uVar7 = FUN_00404ee8(&DAT_0052ff14,param_19[-1]);
                FUN_00404e04(param_19[-1],1,uVar7);
                iVar18 = FUN_00404ee8(&DAT_0052ff08,param_19[-1]);
                if (0 < iVar18) {
                  iVar18 = FUN_00404ee8(&DAT_0052ff08,param_19[-1]);
...
LAB_0052d710:
                  ...
                  puStackY_3c = (uint *)0x52d6a8;
                  puStackY_3c = (uint *)FUN_00404ee8(&DAT_0052ff14,*param_2);
                  local_40 = 0x52d6b6;
                  FUN_004095b0(*param_2,&local_9c);
                  local_40 = 0x52d6c6;
                  iVar18 = FUN_00404ee8(&DAT_0052ff5c,local_9c);
                  if (iVar18 <= (int)puStackY_3c) goto LAB_0052d710;
                  puStackY_3c = &local_94;
                  local_40 = param_19[-6];
                  local_44 = param_19[-10] & 0xfffffdff;
                  local_48 = local_74;
                  local_4c = 0x52d6fc;
                  FUN_00404bf0(&local_a0,local_c,&DAT_0052ff68);
                  local_4c = 0x52d70e;
          ...
          *param_17 = *param_17 + local_6c;
          if (((((int)(*param_17 - local_6c) <= (int)(param_10 - local_94)) &&
             ...
             ((*param_8 = 1, (int)local_90[0] < param_9 &&
              (iVar18 = FUN_004af3c4(local_8,&DAT_0052ff74,param_19[-6]),
      ...
      if ((*(char *)(*param_2 + 1) == '/') && (iVar8 = FUN_00404ba4(*param_2), 3 < iVar8)) {
        ...
        case 0x41:
          if ((((char)param_19[0x14] == '\0') || (param_19[0x1b] == *(uint *)param_19[7])) &&
            ...
            uVar6 = ~CONCAT31((int3)((uint)extraout_EDX >> 8),DAT_0052ff78);
          ...
          *(undefined1 *)((int)param_19 + -0x2a) = 0;
          ...
          if (param_19[0x1c] == *(int *)param_19[7] - 1U) {
            ...
            iVar8 = FUN_004af3c4(local_8,&DAT_0052ff74,param_19[-6]);
            param_19[-4] = param_19[-2] - iVar8;
            pcStackY_38 = (char *)0x52dd6c;
            InflateRect((LPRECT)(param_19 + -5),1,0);
          }
          break;
        case 0x42:
          if (*(char *)(*param_2 + 3) == '>') {
            bVar5 = FUN_0042a660(param_19[-6]);
            uVar6 = ~CONCAT31((int3)((uint)extraout_EDX_00 >> 8),DAT_0052ff7c);
            FUN_0042a66c(param_19[-6],CONCAT31((int3)(uVar6 >> 8),(byte)uVar6 & bVar5));
          }
          else {
            FUN_0042a3a0(param_19[-6],*(undefined4 *)(param_19[-0x12] + 0x18));
        ...
        case 0x49:
          bVar5 = FUN_0042a660(param_19[-6]);
          uVar6 = ~CONCAT31((int3)((uint)extraout_EDX_02 >> 8),DAT_0052ff84);
          FUN_0042a66c(param_19[-6],CONCAT31((int3)(uVar6 >> 8),(byte)uVar6 & bVar5));
          break;
        case 0x4c:
          bVar1 = true;
        ...
        case 0x53:
          ...
          if (cVar4 == 'U') {
            ...
            *(undefined1 *)((int)param_19 + -0x21) = 0;
            ...
            bVar5 = FUN_0042a660(param_19[-6]);
            uVar6 = ~CONCAT31((int3)((uint)extraout_EDX_01 >> 8),DAT_0052ff80);
            FUN_0042a66c(param_19[-6],CONCAT31((int3)(uVar6 >> 8),(byte)uVar6 & bVar5));
          }
          break;
        case 0x55:
          if ((*(char *)(*param_2 + 3) == '>') || ((int)param_19[-0x1c] < 1)) {
            bVar5 = FUN_0042a660(param_19[-6]);
            uVar6 = ~CONCAT31((int3)((uint)extraout_EDX_03 >> 8),DAT_0052ff78);
            FUN_0042a66c(param_19[-6],CONCAT31((int3)(uVar6 >> 8),(byte)uVar6 & bVar5));
          }
          else {
        ...
        case 0x41:
          ...
          *(int *)param_19[7] = *(int *)param_19[7] + 1;
          if ((((char)param_19[0x14] == '\0') || (param_19[0x1b] == *(uint *)param_19[7])) &&
             (param_18 == '\0')) {
            bVar5 = FUN_0042a660(param_19[-6]);
            FUN_0042a66c(param_19[-6],bVar5 | DAT_0052ff78);
            if (param_19[0xf] != 0x1fffffff) {
          ...
          iVar8 = FUN_00404ee8(&DAT_0052ff40,*param_2);
          FUN_00404e04(*param_2,3,iVar8 + -1);
          iVar8 = FUN_00404ee8(&DAT_0052ff90,unaff_EBX);
          iVar8 = iVar8 + 1;
          uVar7 = FUN_00404ba4(unaff_EBX);
          FUN_00404e04(unaff_EBX,iVar8,uVar7);
          iVar8 = FUN_00404ee8(&DAT_0052ff90,unaff_ESI);
        ...
        case 0x42:
          ...
          if (cVar4 == '>') {
            bVar5 = FUN_0042a660(param_19[-6]);
            FUN_0042a66c(param_19[-6],bVar5 | DAT_0052ff7c);
          }
          else if (cVar4 == 'L') {
            ...
            uVar7 = FUN_00404ee8(&DAT_0052ff40,*param_2);
            ...
            if ((param_18 == '\0') && ((char)param_19[0x16] == '\0')) {
              ...
              iVar8 = FUN_0052d0ac("BGCOLOR",unaff_EBX,&local_44);
              if (0 < iVar8) {
                uVar7 = FUN_00404ba4(unaff_EBX);
                ...
                if (0 < iVar8) {
                  if (*unaff_ESI == '#') {
                    local_58 = FUN_0052cd8c(unaff_ESI);
                  }
                  else {
                    FUN_00409724(unaff_ESI,&local_c0);
                    local_58 = FUN_0052c5b4(local_c0);
                  }
                }
                iVar8 = FUN_0052d0ac("BGCOLORTO",unaff_EBX,&local_44);
                if (iVar8 < 1) {
                  uVar6 = FUN_0042ab64(param_19[-8]);
                  param_19[-0x17] = uVar6;
                  ...
                  if (0 < iVar8) {
                    if (*unaff_ESI == '#') {
                      local_5c = FUN_0052cd8c(unaff_ESI);
                    }
                    else {
                      FUN_00409724(unaff_ESI,&local_c4);
                      local_5c = FUN_0052c5b4(local_c4);
                    }
                  }
                  FUN_0040496c(&stack0xffffffe8,&DAT_0052ffcc);
                  iVar8 = FUN_0052d0ac(&DAT_0052ffd8,unaff_EBX,&local_44);
                  if (0 < iVar8) {
                    uVar7 = FUN_00404ba4(unaff_EBX);
            ...
            bVar1 = true;
            FUN_00404bac(param_19[0xb],&DAT_0052ff9c);
          }
          break;
        case 0x45:
          if (param_18 == '\0') {
          ...
          break;
        case 0x46:
          iVar8 = FUN_0052d0ac(&DAT_0052ff40,*param_2,&local_44);
          if (0 < iVar8) {
            FUN_00404e04(*param_2,6,local_44 - 6);
            FUN_004095b0(auStackY_1870[0x5db],&stack0xffffffec);
            iVar8 = FUN_0052d0ac(&DAT_0053016c,unaff_EBX,&local_44);
            if (0 < iVar8) {
              uVar7 = FUN_00404ba4(unaff_EBX);
            ...
            iVar8 = FUN_0052d0ac(" COLOR",unaff_EBX,&local_44);
            ...
            if (((0 < iVar8) && (param_18 == '\0')) && ((char)param_19[0x16] == '\0')) {
              ...
              if (0 < iVar8) {
                if (*unaff_ESI == '#') {
                  ...
                  uVar7 = FUN_0052c5b4(auStackY_1870[0x5d9]);
                  FUN_0042ab6c(param_19[-8],uVar7);
                }
              }
            }
            iVar8 = FUN_0052d0ac(&DAT_0053018c,unaff_EBX,&local_44);
            if (0 < iVar8) {
              uVar7 = FUN_00404ba4(unaff_EBX);
              FUN_00404e04(unaff_EBX,local_44 + 4,uVar7);
              iVar8 = FUN_00404ee8(&DAT_0053019c,unaff_ESI);
              iVar8 = iVar8 + 1;
              uVar7 = FUN_00404ba4(unaff_ESI);
              FUN_00404e04(unaff_ESI,iVar8,uVar7);
              iVar8 = FUN_00404ee8(&DAT_0052ff90,unaff_ESI);
        ...
        case 0x49:
          ...
          if (cVar4 == '>') {
            bVar5 = FUN_0042a660(param_19[-6]);
            FUN_0042a66c(param_19[-6],bVar5 | DAT_0052ff84);
          }
          else if (cVar4 == 'N') {
            iVar8 = FUN_00404ee8(&DAT_0052ff40,*param_2);
            FUN_00404e04(*param_2,3,iVar8 + -1);
            iVar8 = FUN_0052ce44(&DAT_0052ffe4,unaff_EBX);
            iVar8 = iVar8 + 2;
            uVar7 = FUN_00404ba4(unaff_EBX);
            FUN_00404e04(unaff_EBX,iVar8,uVar7);
            iVar8 = FUN_00404ee8(&DAT_0052ff90,unaff_ESI);
            ...
            iVar8 = FUN_00404ee8(&DAT_0052fff0,local_c8);
            iVar8 = iVar8 + 4;
            uVar7 = FUN_00404ba4(unaff_EBX);
            FUN_00404e04(unaff_EBX,iVar8,uVar7);
            iVar8 = FUN_00404ee8(&DAT_0052ff90,unaff_ESI);
            ...
            iVar8 = FUN_00404ee8(&DAT_0052fffc,unaff_EBX);
            ...
            if (0 < iVar8) {
              ...
              uVar7 = FUN_00404ba4(unaff_EBX);
              FUN_00404e04(unaff_EBX,iVar8,uVar7);
              iVar8 = FUN_00404ee8(&DAT_0052ff90,local_20);
              iVar8 = iVar8 + 1;
            ...
            if (0 < iVar8) {
              iVar8 = FUN_0052ce44("HEIGHT",unaff_EBX);
              iVar8 = iVar8 + 7;
              uVar7 = FUN_00404ba4(unaff_EBX);
              FUN_00404e04(unaff_EBX,iVar8,uVar7);
              iVar8 = FUN_00404ee8(&DAT_0052ff90,local_20);
            ...
            if ((0 < iVar8) && (FUN_00404e44(&stack0xffffffe8,1,4), param_19[0x1f] != 0)) {
              ...
              if (iVar8 < iVar18) {
                ...
                if ((param_18 == '\0') && ((char)param_19[0x17] == '\0')) {
                  ...
                  FUN_0052cec8(unaff_ESI);
                  pcStackY_38 = (char *)0x52eb07;
            ...
            if (0 < iVar8) {
              ...
              uStack_28 = &local_dc;
              local_48 = (char *)0x52ebcf;
              FUN_0052c3b0(param_19[-0x27],local_94,local_90[0]);
              param_19[-0x26] = local_dc;
              param_19[-0x25] = local_d8;
              local_48 = (char *)0x52ebf8;
              uVar7 = FUN_0042b5a8(param_19[-0x27]);
              local_48 = (char *)0x52ec02;
              FUN_004af134(local_8,uVar7);
              local_48 = (char *)0x52ec10;
              FUN_00403a84(param_19[-0x27]);
            ...
            if (0 < iVar8) {
              ...
              local_40 = param_19[0x11];
              uStack_28 = &local_dc;
              local_48 = (char *)0x52ecd6;
              FUN_0052c3b0(param_19[-0x27],local_94,local_90[0]);
              param_19[-0x26] = local_dc;
              param_19[-0x25] = local_d8;
              local_48 = (char *)0x52ecff;
              uVar7 = FUN_0042b5a8(param_19[-0x27]);
              local_48 = (char *)0x52ed09;
              FUN_004af134(local_8,uVar7);
              local_48 = (char *)0x52ed17;
              FUN_00403a84(param_19[-0x27]);
              param_19[-0x26] = param_19[-0x26];
              param_19[-0x25] = param_19[-0x25];
            }
            local_50 = (int *)0x0;
            iVar8 = FUN_00404ee8(&DAT_00530058,unaff_ESI);
            ...
            if (0 < iVar8) {
              iVar8 = FUN_00404ee8(&DAT_00530074,unaff_EBX);
              if (iVar8 < 1) {
            ...
            iVar8 = FUN_00404ee8(&DAT_00530094,unaff_EBX);
            if (0 < iVar8) {
              uVar6 = FUN_004af3c4(local_8,&DAT_0052ff74,param_19[-6]);
              *param_16 = uVar6;
              *param_13 = 0;
            }
          }
        ...
        case 0x4c:
          ...
          if (0 < iVar8) {
            ...
            iVar8 = FUN_0052d0ac(&DAT_005300a4,unaff_EBX,&local_44);
            if (0 < iVar8) {
              uVar7 = FUN_00404ba4(unaff_EBX);
              FUN_00404e04(unaff_EBX,local_44 + 4,uVar7);
              iVar8 = FUN_00404ee8(&DAT_0052ff90,unaff_ESI);
            ...
            if (0 < iVar8) {
              ...
              if (0 < iVar8) {
                if (*unaff_ESI == '#') {
                  ...
                  local_58 = FUN_0052c5b4(auStackY_1870[0x5de]);
                }
              }
            }
            iVar8 = FUN_0052d0ac(&DAT_005300c4,unaff_EBX,&local_44);
            if (0 < iVar8) {
              uVar7 = FUN_00404ba4(unaff_EBX);
              FUN_00404e04(unaff_EBX,local_44 + 4,uVar7);
              iVar8 = FUN_00404ee8(&DAT_0052ff90,unaff_ESI);
          ...
          if ((param_18 == '\0') && (*(char *)((int)param_19 + -0x1b) == '\0')) {
            ...
            if (bVar14) {
              ...
              if ((param_19[-0x1c] & 1) == 0) {
                pcStackY_38 = (char *)0x1fffffff;
                puStackY_3c = (uint *)0x52f325;
                FUN_004af154(local_8,&DAT_005300f0,1);
              }
              else {
                pcStackY_38 = (char *)0x1fffffff;
                puStackY_3c = (uint *)0x52f2fc;
                FUN_004af154(local_8,&DAT_005300e4,1);
              }
              puStackY_3c = (uint *)0x52f333;
              FUN_0042a5c8(param_19[-6],unaff_ESI);
              if (local_58 != 0x1fffffff) {
                puStackY_3c = (uint *)0x52f354;
        ...
        case 0x50:
          ...
          if (0 < iVar8) {
            ...
            iVar8 = FUN_0052d0ac("ALIGN",unaff_EBX,&local_44);
            if (0 < iVar8) {
              uVar7 = FUN_00404ba4(unaff_EBX);
              FUN_00404e04(unaff_EBX,local_44 + 5,uVar7);
              iVar8 = FUN_00404ee8(&DAT_0052ff90,unaff_ESI);
              ...
              iVar8 = FUN_00404ee8(&DAT_0053013c,unaff_ESI);
              if (0 < iVar8) {
                *param_12 = 0;
              }
            ...
            iVar8 = FUN_0052d0ac("INDENT",unaff_EBX,&local_44);
            if (0 < iVar8) {
              uVar7 = FUN_00404ba4(unaff_EBX);
              FUN_00404e04(unaff_EBX,local_44 + 6,uVar7);
              iVar8 = FUN_00404ee8(&DAT_0052ff90,unaff_ESI);
              ...
              if (iVar8 < 1) {
                ...
                if (0 < iVar8) {
                  if (*unaff_ESI == '#') {
                    ...
                    local_5c = FUN_0052c5b4(auStackY_1870[0x5dc]);
                  }
                }
                if (param_18 == '\0') {
                  *(undefined1 *)((int)param_19 + -0x69) = 1;
        ...
        case 0x53:
          ...
          if (cVar4 == '>') {
            bVar5 = FUN_0042a660(param_19[-6]);
            FUN_0042a66c(param_19[-6],bVar5 | DAT_0052ff80);
          }
          else if (cVar4 == 'H') {
            *(undefined1 *)((int)param_19 + -0x21) = 1;
          }
          else {
            iVar8 = FUN_0052ce44("<SUB>",*param_2);
            if (iVar8 == 1) {
              *(undefined1 *)((int)param_19 + -0x19) = 1;
            }
            else {
              iVar8 = FUN_0052ce44("<SUP>",*param_2);
              if (iVar8 == 1) {
