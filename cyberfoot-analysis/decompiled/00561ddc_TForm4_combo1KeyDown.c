...
void TForm4_combo1KeyDown(int param_1,undefined4 param_2,short *param_3)

{
  ...
  *in_FS_OFFSET = &uStack_38;
  ...
  if (*param_3 == 0x4d) {
    puStack_30 = &stack0xfffffffc;
    iVar3 = (**(code **)(**(int **)(*(int *)(param_1 + 0x34c) + 0x23c) + 0x14))();
    if (-1 < iVar3 + -1) {
      iVar4 = 0;
      uVar5 = true;
      do {
        puVar6 = &local_10;
        piVar1 = *(int **)(*(int *)(local_8 + 0x34c) + 0x23c);
        (**(code **)(*piVar1 + 0xc))(piVar1,iVar4,&local_14,puVar6);
        FUN_00404e04(local_14,1,2,puVar6);
        FUN_00404cf0(local_10,&LAB_00561f40);
        if ((bool)uVar5) {
          FUN_0054c10c(*(undefined4 *)(local_8 + 0x34c),iVar4);
          break;
        }
        iVar4 = iVar4 + 1;
        iVar3 = iVar3 + -1;
  ...
  puVar2 = puStack_30;
  *in_FS_OFFSET = uStack_38;
  puStack_30 = &LAB_00561f2d;
  puStack_34 = (undefined1 *)0x561f25;
