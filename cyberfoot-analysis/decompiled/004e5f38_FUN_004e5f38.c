...

{
  ...
  FUN_0041c990(0,0,uVar4,puVar7,uVar1);
  puVar7 = local_44;
  ...
  if (-1 < iVar2 + -1) {
    ...
    do {
      ...
      if (-1 < iVar2 + -1) {
        do {
          FUN_004e5ee0(&local_8,&local_11,&local_12,&local_17,&local_13);
          FUN_004e5eb8(&local_10,&local_14,&local_15,&local_16);
          uVar5 = (uint)local_17;
          ...
          FUN_004e5f14(&local_c,uVar1,uVar6,uVar4);
          iVar2 = iVar2 + -1;
        } while (iVar2 != 0);
      }
      iVar3 = iVar3 + 1;
