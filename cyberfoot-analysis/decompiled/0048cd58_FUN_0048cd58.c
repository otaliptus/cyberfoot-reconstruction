...
int FUN_0048cd58(int *param_1,int *param_2,uint param_3,int param_4,uint param_5)

{
  ...
  if ((param_3 < (uint)param_2[6]) || ((uint)(param_2[6] + param_2[4]) < uVar4)) {
    ...
    if (param_2[9] != 0) {
      FUN_0048cb64(param_1,param_2,1);
      param_2[9] = 0;
    }
    ...
    FUN_0048cb64(param_1,param_2,0);
  }
  if ((uint)param_2[7] < uVar4) {
    ...
    if (param_2[8] == 0) {
      ...
      for (uVar3 = uVar3 - iVar1; uVar3 < uVar4 - iVar1; uVar3 = uVar3 + 1) {
        FUN_00497770(*(undefined4 *)(*param_2 + uVar3 * 4),iVar2 << 7);
      }
    }
  }
  if (param_4 != 0) {
