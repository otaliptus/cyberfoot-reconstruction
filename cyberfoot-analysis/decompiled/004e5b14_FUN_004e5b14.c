...
uint FUN_004e5b14(undefined4 param_1,DWORD param_2,DWORD param_3,uint param_4)

{
  if (0xff < param_4) {
    FUN_00404830("Assertion failure","C:\\Components\\Berg\\Sources\\NxSharedCommon.pas",0x442);
  }
  if ((int)param_2 < 0) {
