...
void TForm63_Image3Click(int param_1)

{
  ...
  *in_FS_OFFSET = &uStack_2c;
  ...
  FUN_00465978(*(undefined4 *)(param_1 + 0x360),*(undefined4 *)(*(int *)(param_1 + 0x34c) + 0x40));
  puVar1 = puStack_28;
  *in_FS_OFFSET = uStack_30;
  puStack_28 = &LAB_005c7ba4;
  uStack_2c = 0x5c7b8f;
