...
void FUN_004c7cdc(undefined4 param_1,int param_2,int param_3,int param_4)

{
  ...
  if (cVar2 == '\0') {
    uVar5 = FUN_004323b8(0,param_3);
  }
  else {
    FUN_00432334(100,param_3 + 100);
    uVar5 = FUN_00402c38();
  }
  if (cVar3 == '\0') {
    uVar6 = FUN_004323b8(0,param_4);
  }
  else {
    FUN_00432334(100,param_4 + 100);
    uVar6 = FUN_00402c38();
  }
