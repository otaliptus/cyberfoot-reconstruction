...
void TForm19_grid1CellFormating
...

{
  ...
  local_8 = 0;
  puStack_18 = &LAB_005ef27d;
  uStack_1c = *in_FS_OFFSET;
  *in_FS_OFFSET = &uStack_1c;
  iVar2 = (**(code **)(**(int **)(param_1 + 0x2f8) + 0x11c))();
  if ((param_7 < iVar2) && ((param_4 & 8) == 0)) {
    (**(code **)(**(int **)(param_1 + 0x2f8) + 0x100))
              (*(int **)(param_1 + 0x2f8),0,param_7,&local_8);
    bVar3 = true;
    FUN_00405378(local_8);
    if (bVar3) {
      *param_5 = DAT_005ef28c;
    }
  }
  puVar1 = puStack_14;
  *in_FS_OFFSET = uStack_1c;
  puStack_14 = &LAB_005ef284;
  puStack_18 = (undefined1 *)0x5ef27c;
