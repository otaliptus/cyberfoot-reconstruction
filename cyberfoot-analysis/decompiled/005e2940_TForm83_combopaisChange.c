...
void TForm83_combopaisChange(int param_1)

{
  ...
  local_1c = 0;
  local_20 = 0;
  puStack_2c = &LAB_005e2b0c;
  uStack_30 = *in_FS_OFFSET;
  *in_FS_OFFSET = &uStack_30;
  DAT_006d34d4 = FUN_0054c0f0(*(undefined4 *)(param_1 + 0x364));
  ...
  FUN_0054cd98(*(undefined4 *)(param_1 + 0x328),local_8);
  if (*(int *)(PTR_DAT_0066ac78 + 0x168) == 2) {
    ...
    if (2 < *(int *)(*(int *)PTR_DAT_0066aca0 + 0x144 + DAT_006d34d4 * 0x294)) {
      ...
      FUN_0054cd98(*(undefined4 *)(param_1 + 0x328),local_10);
    }
    if (3 < *(int *)(*(int *)PTR_DAT_0066aca0 + 0x144 + DAT_006d34d4 * 0x294)) {
      FUN_00642c50(0x26,&local_14);
      FUN_0054cd98(*(undefined4 *)(param_1 + 0x328),local_14);
    }
  }
  if (*(int *)(PTR_DAT_0066ac78 + 0x168) == 4) {
    FUN_00642c50(0x24,&local_18);
    FUN_0054cd98(*(undefined4 *)(param_1 + 0x328),local_18);
  ...
  puVar1 = puStack_28;
  *in_FS_OFFSET = uStack_30;
  puStack_28 = &LAB_005e2b13;
  puStack_2c = (undefined1 *)0x5e2b0b;
