...
void FUN_005c4458(undefined4 param_1,int param_2,int param_3)

{
  ...
  local_1c = 0;
  local_20 = 0;
  puStack_34 = &LAB_005c45ab;
  uStack_38 = *in_FS_OFFSET;
  *in_FS_OFFSET = &uStack_38;
  local_8 = param_3;
  FUN_00409dd8(param_1,&local_10,param_3,&DAT_005c45c4);
  FUN_00404c64(&local_c,3);
  iVar1 = FUN_00427360(DAT_006d2b98,local_c);
  puVar5 = &DAT_005c45c4;
  FUN_00409dd8(param_1,&local_18);
  puVar3 = &DAT_005c45dc;
  uVar4 = local_18;
  FUN_00404c64(&local_14,3);
  iVar2 = FUN_00427360(DAT_006d2b98,local_14);
  ...
  FUN_004663a8(iVar2,*(undefined4 *)(*(int *)PTR_DAT_0066af70 + 0xac + local_8 * 0x2f8));
  FUN_0042a3a0(*(undefined4 *)(iVar2 + 0x68),
               *(undefined4 *)(*(int *)PTR_DAT_0066af70 + 0xb0 + local_8 * 0x2f8));
  *in_FS_OFFSET = puVar3;
  FUN_004048f8(&local_20,6,puVar5,&LAB_005c45b2);
  return;
}
