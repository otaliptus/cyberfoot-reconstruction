...
void FUN_004f7d30(int param_1,undefined4 param_2,undefined4 param_3,int param_4)

{
  ...
  while( true ) {
    ...
    if (*(char *)(iVar1 + 0x21) != '\0') {
      uVar5 = 0x4f7d63;
      FUN_004f671c(*(undefined4 *)(*piVar4 + 0x598),iVar3,0);
      if (*(int *)(*piVar4 + 0x4f0) < iVar3) {
        *(int *)(*piVar4 + 0x4f0) = *(int *)(*piVar4 + 0x4f0) + -1;
      }
      uVar6 = 0;
      iVar1 = FUN_004f7890(*piVar4,iVar3);
