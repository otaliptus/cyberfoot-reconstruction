...
void FUN_004c48d0(undefined4 param_1,uint param_2,undefined4 param_3,ushort param_4,byte *param_5,
...
LAB_004c4919:
      do {
        ...
        if (bVar1) {
          ...
          FUN_004c43c8(*param_6 & 0xf,CONCAT31((int3)(uVar4 >> 8),(char)uVar4 + (*param_6 & 0xf)),
        ...
        FUN_004c43c8(*param_6 >> 4,(*param_7 >> 4) + (*param_6 >> 4),param_4,param_2,param_3);
