...
void FUN_00536070(int param_1,undefined4 param_2,undefined4 param_3,char param_4,int *param_5,
...

{
  ...
  if (param_7 != 0x1fffffff) {
    ...
    FUN_0042a88c(*(undefined4 *)(param_1 + 0x10),param_7);
    FUN_0042b158(param_1,iVar1,iVar2,iVar4,iVar3);
  }
  return;
}
