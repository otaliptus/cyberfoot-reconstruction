...
The cumulative development ledger records **251,707 original-comparison cases** through the latest next-state work. This is a historical coverage count, not unique features or a formal equivalence guarantee. Older READMEs contain earlier totals.
