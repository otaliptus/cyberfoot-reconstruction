...
The Turkish new-career flow also reached the Greuther Fürth club screen with accented player names intact. Published code `4791fca` as https://5cee7fcb.cyberfoot-original-emulator.pages.dev/ on the existing stable URL.
